...
function HeroHome() {
  ...
  return (
    <div className="w-full max-w-xl bg-palewhite py-12  text-md text-center flex items-center justify-center flex-col">
      <h3 className="font-serif tracking-[0.5em]">THE WEDDING OF</h3>
      <h1 className="font-vibes text-6xl py-6 text-secondary">
        Welsen & Elene
      </h1>
      <h3 className="font-serif tracking-[0.1em]">
      ...
      <p className="my-4 px-6 text-base font-serif font-medium">
